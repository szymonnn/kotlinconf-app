...
class ScheduleFragment : BaseFragment(), AnkoComponent<Context>, ScheduleView {
    ...
    val title: String = "Sessions"

    private val service by lazy { (activity!!.application as KotlinConfApplication).service }
    private val presenter by lazy { SchedulePresenter(this, service) }
    ...
    override fun onUpdate(sessions: List<List<Session>>, favorites: List<Session>) {
